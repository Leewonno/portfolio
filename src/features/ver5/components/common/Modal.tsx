    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="fixed z-50 top-1/2 left-1/2 w-135 max-w-[90vw] max-h-[82vh] overflow-y-auto thin-scrollbar px-6 py-8 sm:p-8 rounded-2xl bg-white shadow-[0px_24px_64px_rgba(0,0,0,0.12)] data-[state=open]:animate-[modal-in_0.25s_ease-out_forwards] data-[state=closed]:animate-[modal-out_0.2s_ease-in_forwards] flex flex-col gap-6 sm:gap-8 outline-none will-change-[translate,opacity,scale]"
        >
          {/* 헤더 */}
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              <Dialog.Title className="text-2xl sm:text-3xl font-semibold text-gray-800 mr-2">
                {title}
              </Dialog.Title>
              {link && (
                <a
